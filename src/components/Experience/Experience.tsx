...
const Experience = () => {
   return (
      <section className="container m-auto h-[70vh] max-h-[816px] relative  items-center justify-center flex">
         <div className="w-[80%]  p-[5%]  bg-white shadow-[12px_12px_4px_0px_rgba(191,191,180,1.00)] border-4 border-black flex flex-col justify-center items-center gap-2.5 ">
            <div className="h-[80px] justify-center items-center inline-flex text-black text-4xl md:text-[64px]  font-['Space_Grotesk']">
